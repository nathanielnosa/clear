...
//     $('.secondary-nav-internal-navigation .nav-link').on("click", function (e) {
//         e.preventDefault();
//         $('html, body').animate({
...
//                 $('.secondary-nav-internal-navigation .nav-link').removeClass('active');
//                 $('.secondary-nav-internal-navigation .nav-link[data-scroll="' + sectionID + '"]').addClass('active');
//             }
//         });
//     });
